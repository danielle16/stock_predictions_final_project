...
print(f"Finished in {round(finish-start,2)} in second(s) -->FOR 1st timer")

#
start = time.perf_counter()
#
# load optimal model weights from results folder
model_path = os.path.join("results", "quick") + ".h5"
...
finish = time.perf_counter()
#
print(f"Finished in {round(finish-start,2)} in second(s) -->FOR 2st timer")
